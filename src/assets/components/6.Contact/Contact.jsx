...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "Y.A Const", // Updated Service ID
        "template_9fllu0h", // Updated Template ID
        form.current,
        "vZB1ditY-44IPg6Qp" // Updated Public Key
      )
      .then(
        (result) => {
    ...
    <section id="contact" className="contact">
      <div className="contact-container">
        ...
        <div className="contact-info">
          ...
          <p>
            <FaEnvelope /> <strong>Email:</strong> contact@y.acompany.com
          </p>
          <p>
